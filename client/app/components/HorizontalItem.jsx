...
const HorizontalItem = ({ title, iconDesc, colorIconDesc, desc, colorDesc, iconRight, onPress, isCenter, isIconDesc, isAvt }) => {
        ...
        <TouchableOpacity style={styles.container} onPress={onPress}>
            <View style={isCenter ? styles.centeredTitleContainer : styles.titleContainer}>
                ...
                {!isCenter && <View style={styles.infoContainer}>
                    {isIconDesc && <Ionicons name={iconDesc} size={16} style={[styles.icon, {color: colorIconDesc, marginRight: 4}]} />}
